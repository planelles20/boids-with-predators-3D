...
int main(void){
    ...
    // create our window
    Display display = Display(WIDTH, HEIGHT, "Boids with predators, Carlos Planelles",
    ...
    while(i<1000000 && display.State()){
        ...
        systemSPH.Calculate();
        //systemSPH.Indices_print();
        //systemSPH.Calc_print();
        //systemSPH.Particle_print();
        //i = 1000000;
        /*
        // save current data
        if(i%10000==0){
            systemSPH.Save("save0.csv");
        }
        */
...
void do_movement() {
    // Camera controls
    GLfloat cameraSpeed = 0.3*3.0f * deltaTime;
